function InputParamsKatelynP24()
    ...
    S["Bout_Minimums"] = Dict("W" => 2, "N" => 2, "R" => 2)  # You need at least 2 epochs in a row to be counted as a bout.
    ...
    # S["path_to_WT_BL_Males_files"] = joinpath(base_path, "P24", "WT_BL_M")
    # S["path_to_WT_SD_Males_files"] = joinpath(base_path, "P24", "WT_SD_M")
    # S["path_to_Mut_BL_Males_files"] = joinpath(base_path, "P24", "Ube3aHET_BL_M")
    # S["path_to_Mut_SD_Males_files"] = joinpath(base_path, "P24", "Ube3aHET_SD_M")
    # S["path_to_WT_BL_Females_files"] = joinpath(base_path, "P24", "WT_BL_F")
    # S["path_to_WT_SD_Females_files"] = joinpath(base_path, "P24", "WT_SD_F")
    # S["path_to_Mut_BL_Females_files"] = joinpath(base_path, "P24", "Ube3aHET_BL_F")
    # S["path_to_Mut_SD_Females_files"] = joinpath(base_path, "P24", "Ube3aHET_SD_F")
    S["path_to_WT_BL_Males_files"] = "/Users/sofiashchukina/Desktop/EEG script Jullia/"
    S["path_to_WT_SD_Males_files"] = "/Users/sofiashchukina/Desktop/EEG script Jullia/"
    S["path_to_Mut_BL_Males_files"] = "/Users/sofiashchukina/Desktop/EEG script Jullia/"
    S["path_to_Mut_SD_Males_files"] = "/Users/sofiashchukina/Desktop/EEG script Jullia/"
    S["path_to_WT_BL_Females_files"] = "/Users/sofiashchukina/Desktop/EEG script Jullia/"
    S["path_to_WT_SD_Females_files"] = "/Users/sofiashchukina/Desktop/EEG script Jullia/"
    S["path_to_Mut_BL_Females_files"] = "/Users/sofiashchukina/Desktop/EEG script Jullia/"
    S["path_to_Mut_SD_Females_files"] = "/Users/sofiashchukina/Desktop/EEG script Jullia/"
    ...
    S["FileName"] = @__FILE__
    S["FuncName"] = string(nameof(InputParamsKatelynP24))
...
@assert params["epochs"] == 900 "epochs should be 900"
@assert params["numhrs"] == 24 "numhrs should be 24"
@assert params["Light"] == 1:10800 "Light should be 1:10800"
